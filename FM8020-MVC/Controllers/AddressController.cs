...
namespace FM8020_MVC.Controllers
{
    public class AddressController : Controller
    {
        ...
        public AddressController(FMContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Street,City,Postcode,Number")] AddressModel addressModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Street,City,Postcode,Number")] AddressModel addressModel)
        {
